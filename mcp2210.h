...
#define GPIO_DES_GPIO 0x00
#define GPIO_DES_CS 0x01
#define GPIO_DES_DEDICATED 0x2
 ...
 *      <0:  Other device errors (see error codes)
 */
int SetPowerUpDefaultChipSettings(hid_device *handle, ChipSettingsDef def, bool isVolatile = true);
